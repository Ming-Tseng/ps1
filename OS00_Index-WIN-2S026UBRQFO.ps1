...
pwd: p@ssw0rd  ; pass@word1SP2013	    172.16.220.29	192.168.112.124
...
#>}$-----------------OS09_modules{<#\\172.16.220.29\c$\Users\administrator.CSD\SkyDrive\download\PS1\OS09_modules.ps1# 01 50  $env:PSModulePath  :查詢預設模組位置
...
$-----------------OS15_cluster{<#\\172.16.220.29\c$\Users\administrator.CSD\SkyDrive\download\ps1\OS15_cluster.ps1#01      General command 
#02      Network check 
#03      Get  IP Address
...
#>}$-----------------SQLPS06_BCP\\172.16.220.29\c$\Users\administrator.CSD\OneDrive\download\PS1\SQLPS06_BCP.ps1{<##  (1)  50  bulk export using invoke-sqlcmd to CSV file
