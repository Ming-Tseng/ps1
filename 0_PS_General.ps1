<#
 Create date :APR.23.2014
 Filelocation :    \\10.0.21.113\c$\software\ps1\cluster\0_PS_General.ps1
 Close date: JUN.06.2014   ,
 Next : \\10.0.21.113\c$\software\ps1\cluster\01_PS_perfmon.ps1
...
#309  funtion  update SQL  cluster owner Nodes
#08   Table HostsDisks
...
#15    745   failover to another 
#16    800  sys.availability
#17    850   function EstimateTime ( $SQLCluster)
# 1119   udpate table SQLServers  step1
#1414   part II
# 2592     SQL_E_2012_backup   1  -User Profile xxx
# 2630     SQL_E_2012backup  2    +User Profile xxx
# 2666  20140514   AG   for    asset   test
# 2788  20140514   AG   for    EIP   test
# 2966    troubshooting   database    suspect  state
#   3000   cluster quorun  set
# 3071   Force WSFC cluster to  start with a Quorum  with asset 
# 3108   Force WSFC cluster to  start with a Quorum  with EIP 
# 3244   tracert  -d 
#  3360    Backup   WinMasterVI
#  3388  Backup   SessionReconding
# 5000    TSQL
#  TcpClient   
...
#>
 ...
 #----------------------------------------------------------------------------------------------
#    26   1119   udpate table SQLServers  step1
#----------------------------------------------------------------------------------------------
$ivSQL= "SQLASSETDB"
$ivDatabase="SQL_inventory"
...
$DatabaseBackupFile = "\\10.0.23.114\r$\backupNBU\"+$AddAGDatabase+$bdate+".bak"
$LogBackupFile            = "\\10.0.23.114\r$\backupNBU\"+$AddAGDatabase+$bdate+".trn"

$Node1Name="SQL-X-2012"    ;$SQLCluster1=$Node1Name
$Node2Name="SQL-E-2012"  ;$SQLCluster2=$Node2Name
...
Invoke-Sqlcmd $sql_ldfbackup     -ServerInstance $Node1Name  -QueryTimeout 14400
$t2=get-date
($t2-$t1).TotalSeconds  #156.3578829sec #192.1767159   #5666.9390071   data 51.200000G
...
$sql_mdfbackup="BACKUP DATABASE $AddAGDatabase TO  DISK = N'$DatabaseBackupFile'" ;$sql_mdfbackup
$sql_ldfbackup  = "BACKUP Log  $AddAGDatabase  TO  DISK = N'$LogBackupFile' "  ;$sql_ldfbackup


Invoke-Sqlcmd $sql_mdfbackup  -ServerInstance "SQL-E-2012"  -QueryTimeout 14400
Invoke-Sqlcmd $sql_ldfbackup     -ServerInstance "SQL-E-2012"  -QueryTimeout 14400
$t3=get-date
...
AssetAGOwneIP
Function CheckAssetDB 
{ 
Clear-Host
    $sqlonline="select  getdate() as D ;  select @@Servername as N"
    $SPA=Invoke-Sqlcmd -ServerInstance SQLASSETDB  -Query $sqlonline
    '-----------------'
    " SQLASSETDB   running    @   " +  $SPA.N  +'    now is '+  ($SPA.D)
}
...
AG Listener         AG Name             ip_address          state_desc         
-----------         -------             ----------          ----------         
SPE                 SP2013_SQLE_AG      10.0.23.118         ONLINE             
SPE                 SP2013_SQLE_AG      10.1.23.118         OFFLINE            

GetAGState spe1

AG Listener         AG Name             ip_address          state_desc         
-----------         -------             ----------          ----------         
SPE1                SP2013_SQLE1_AG     10.0.23.119         ONLINE             
SPE1                SP2013_SQLE1_AG     10.1.23.119         OFFLINE
'
...
SQL_E_OS                      檔案共用見證                            NodeAndFileShareMajority
----     B            --    -----                                               
00DPHCSSL03          2     Up                                                  
00DPHCSSL04          1     Up                                                  
01DPHCSSL03          3     Up                                                  
...
'
Get-Cluster |  get-clusterresource  "檔案共用見證"  | Get-ClusterParameter |FL
'
Name          : SharePath
IsReadOnly    : False
ParameterType : String
Value         : \\10.1.24.182\clusterFileMajority
'

##-SQL_B_OS

#Set-ClusterQuorum   -NodeAndFileShareMajority   "\\10.5.0.13\BFileMajority"
  Set-ClusterQuorum   -NodeAndFileShareMajority   "\\10.1.21.151\filemajority"
#Set-ClusterQuorum   -NodeAndDiskMajority  "PR Q"
Get-Cluster |  get-clusterresource  "檔案共用見證"  | Get-ClusterParameter |FL
Get-ClusterQuorum
...
Set-ClusterQuorum   -NodeAndFileShareMajority   "\\10.5.0.13\EFileMajority"
Set-ClusterQuorum   -NodeAndFileShareMajority   "\\10.1.24.182\clusterFileMajority"
#Set-ClusterQuorum   -NodeAndDiskMajority  "PR-E-Q-10G(1)"
Get-Cluster |  get-clusterresource  "檔案共用見證"  | Get-ClusterParameter |FL
Get-ClusterQuorum

}

telnet  10.1.24.182  445
#----------------------------------------------------------------------------------------------
#  3071 Force WSFC cluster to  start with a Quorum  with asset 
#----------------------------------------------------------------------------------------------
{
\\10.1.21.151\filemajority  #  Asset 
...
$n1.NodeWeight=1 ; $n1 | select  NodeName, NodeWeight
$n2.NodeWeight=1; $n2 | select  NodeName, NodeWeight
$n3.NodeWeight=0 ; $n3 | select  NodeName, NodeWeight
$n4.NodeWeight=0  ; $n4 | select  NodeName, NodeWeight

 $n1 | select  NodeName, NodeWeight,state
 $n2 | select  NodeName, NodeWeight,state
 $n3 | select  NodeName, NodeWeight,state
 $n4 | select  NodeName, NodeWeight,state
...
{
##-----------------------0-- Get  Quorum
\\01DPHASNC02\clusterFileMajority   # EIP   \\10.1.24.182\clusterFileMajority
...
Get-ClusterNode
$nodeS="00DPHCSSC01","00DPHCSSC02","01DPHCSSC01","01DPHCSSC02"
$eipn1=Get-Clusternode $nodeS[0]
$eipn2=Get-Clusternode $nodeS[1]
$eipn3=Get-Clusternode $nodeS[2]
$eipn4=Get-Clusternode $nodeS[3]

 $eipn1 |select *
 $eipn1 | select  NodeName, NodeWeight,state
 $eipn2 | select  NodeName, NodeWeight,state
 $eipn3 | select  NodeName, NodeWeight,state
 $eipn4 | select  NodeName, NodeWeight,state
#0-- set Quorum

##-----------------------1)--Force  WSFC cluster to Start without a Quorum
#Stop-ClusterNode  $n3

Start-ClusterNode -Name  $eipn3  -FixQuorum
$eipn3.NodeWeight=1
$eipn3 | select  NodeName, NodeWeight

##-----------------------2.1 )--  Plans Manual Failover of  AG


Alter  Availability Group  SP2013_SQLE_AG   FAILOVER

Alter  Availability Group  SP2013_SQLE1_AG   FAILOVER
 ref
...
#-----------------------2.2)--  Forced Manual Failover of  AG

#  Alter  Availability Group  SP2013_SQLE_AG   FORCE_FAILOVER_ALLOW_DATA_LOSS
#  Alter  Availability Group  SP2013_SQLE1_AG   FORCE_FAILOVER_ALLOW_DATA_LOSS

$SPE_ForcedFailover  ="ALTER AVAILABILITY GROUP  [SP2013_SQLE_AG]  FORCE_FAILOVER_ALLOW_DATA_LOSS"
$SPE1_ForcedFailover="ALTER AVAILABILITY GROUP  [SP2013_SQLE1_AG]  FORCE_FAILOVER_ALLOW_DATA_LOSS"
 #  Invoke-Sqlcmd -ServerInstance  "SQL-X-2012"    -Query $SPE_ForcedFailover
 #  Invoke-Sqlcmd -ServerInstance  "SQL-X1-2012"  -Query $SPE1_ForcedFailover
 
 'Invoke-Sqlcmd -ServerInstance "SQL-X-2012"    -Query  "select @@servername" 
 SQL-X-2012\SQLX  
 
  Invoke-Sqlcmd -ServerInstance "SQL-X1-2012"    -Query  "select @@servername" 
  SQL-X1-2012\SQLX1
  '
  #-----------------------23)--    look lsn _backup

  select last_commit_lsn,last_commit_time ,* from sys.dm_hadr_database_replica_states
where database_id =DB_ID('WSS_Logging')


select * from sys.dm_hadr_database_replica_cluster_states
where database_name ='WSS_Logging'

select * from sys.dm_hadr_database_replica_states
where database_id =DB_ID('WSS_Logging')

select * from sys.dm_hadr_availability_replica_cluster_states dharcs

select dharcs.replica_server_name
...
join sys.dm_hadr_availability_replica_cluster_states dharcs on dhdrcs.replica_id=dharcs.replica_id
--join sys.dm_hadr_database_replica_states             dhdrs  on dhdrs.replica_id=dharcs.replica_id

where dhdrcs.database_name ='WSS_Logging'
order by dhdrcs.database_name
}
...
#   3244   tracert  -d 
#----------------------------------------------------------------------------------------------
tracert -d  10.1.24.182
tracert -d  10.1.23.113

'
tracert -d  10.1.24.182

Tracing route to 10.1.24.182 over a maximum of 30 hops

  1    <1 ms    <1 ms    <1 ms  10.0.23.251 
  2    <1 ms    <1 ms    <1 ms  10.0.1.254 
  3    <1 ms    <1 ms    <1 ms  10.0.5.254 
  4     1 ms     3 ms     1 ms  10.0.6.254 
  5     2 ms     2 ms     1 ms  10.0.7.251 
  6     2 ms     1 ms    <1 ms  10.0.7.252 
  7     2 ms     1 ms     2 ms  192.168.1.6 
  8     4 ms     5 ms     4 ms  1.0.0.26 
  9     5 ms     5 ms     5 ms  192.168.1.13 
 10     5 ms     6 ms     5 ms  10.1.7.240 
 11     6 ms     5 ms     5 ms  10.1.6.240 
 12     5 ms     5 ms     5 ms  10.1.5.240 
 13     5 ms     5 ms     5 ms  10.1.1.241 
 14     6 ms     5 ms     5 ms  10.1.24.182 

Trace complete.
'
tracert -d  10.1.23.113
tracert -d  10.1.23.114
'tracert -d  10.1.23.114

Tracing route to 10.1.23.114 over a maximum of 30 hops

  1    <1 ms    <1 ms    <1 ms  10.0.23.251 
  2    <1 ms    <1 ms    <1 ms  10.0.1.254 
  3     4 ms     4 ms     4 ms  10.0.13.254 
  4     9 ms     7 ms    12 ms  10.0.19.253 
  5     *        *        *     Request timed out.
  6     *        *        *     Request timed out.
  7     6 ms     6 ms     7 ms  10.1.23.114 
  '
#-----------------------------------------
#    EstimatedEndTime
#-----------------------------------------
...
{
$bdate="_2014051511"
$bDatabase="WinMasterVI"
$SQLCluster="SQL-B-2012"   

$DatabaseBackupFile = "\\10.0.23.113\r$\backupNBU\Asset\"+$bDatabase+$bdate+".bak"
$LogBackupFile            = "\\10.0.23.113\r$\backupNBU\Asset\"+$bDatabase+$bdate+".trn"

$sql_mdfbackup="BACKUP DATABASE $bDatabase TO  DISK = N'$DatabaseBackupFile'" ; 
$sql_ldfbackup  = "BACKUP Log  $bDatabase  TO  DISK = N'$LogBackupFile' "  ;

$t1=get-date;'Start -->'+$t1
#Invoke-Sqlcmd $sql_mdfbackup  -ServerInstance $SQLCluster  -QueryTimeout 14400
Invoke-Sqlcmd $sql_ldfbackup     -ServerInstance $SQLCluster  -QueryTimeout 14400
$t2=get-date;'End <--'+$t2
($t2-$t1).TotalMinutes
}
...
#  3388  Backup   SessionReconding
#-------------------------------------------------------
$SQLCluster="SQL-D-2008R2"   
$bDatabaseS="ObserveIT","ObserveIT_Archive_1","ObserveIT_Archive_Template","ObserveIT_Data"
$bdate="_2014051513"

for ($i = 0; $i -le 2; $i++) # for ($i = 0; $i -le 3; $i++)
{ #2
$DatabaseBackupFile = "\\sql-b-2012\y$\bak\"+$bDatabaseS[$i ]+$bdate+".bak"
$LogBackupFile            = "\\sql-b-2012\y$\bak\"+$bDatabaseS[$i ]+$bdate+".trn"
$sql_mdfbackup="BACKUP DATABASE  "+$bDatabaseS[$i ] +" TO  DISK = N'"+$DatabaseBackupFile+"'" ; $sql_mdfbackup
$sql_ldfbackup   ="BACKUP Log  "+$bDatabaseS[$i ] +" TO  DISK = N'"+$LogBackupFile+"'" ; $sql_ldfbackup
...
'
$env:computername
Get-counter  -ComputerName  00DPHCSSC01   "\Processor(_total)\% Processor Time"   -SampleInterval 2 -MaxSamples 1000  | Export-counter -Path C:\perfmon\Processor_Time.blg

icm -Comp

ping 00DPHIMSA01   10.0.25.69
ping 00DPHIMSA02  10.0.25.61
ping 00DPHIMSA03   10.0.25.62


ping 00DPHCSSD01   10.0.25.65
ping 00DPHCSSD02   10.0.25.64
ping 00DPHCSSD03   10.0.25.63

ping 00DVGIMSA02   10.0.25.73
ping 00DVGIMSA03   10.0.25.74
ping 00DVGIMSA04   10.0.25.75


#-----------------------------------
#
#-----------------------------------
$t1      = Get-date  '2014/5/17 下午 09:00:00'
$t2      = Get-date  '2014/5/17 下午 09:40:00'
$EIPPRAP="00DPHCSSD01","00DPHCSSD02","00DPHCSSD03","00DVGIMSA02","00DVGIMSA03","00DVGIMSA04",'00DPHIMSA02','00DPHIMSA03'


$EIPPRAP="10.0.25.65","10.0.25.64","10.0.25.63","10.0.25.73","10.0.25.74","10.0.25.75"
$AP63=$EIPPRAP[2];$AP64=$EIPPRAP[1];$AP65=$EIPPRAP[0]
$AP73=$EIPPRAP[3];$AP74=$EIPPRAP[4];$AP75=$EIPPRAP[5]
$AP61=$EIPPRAP[6];$AP61=$EIPPRAP[7]
    icm -ComputerName 10.0.25.65  {  hostname}
    ssms
$EIPPRAP=
$EIPPRAP="10.0.25.65","10.0.25.64","10.0.25.63","10.0.25.73","10.0.25.74","10.0.25.75","10.0.25.61","10.0.25.62"
$EIPPRAP="00DPHCSSD01","00DPHCSSD02","00DPHCSSD03","00DVGIMSA02","00DVGIMSA03","00DVGIMSA04",'00DPHIMSA02','00DPHIMSA03'
for ($i = 0; $i -lt 8; $i++)
{ 
    #$t11=get-date
    $EIPPRAP[$i]
   # icm -ComputerName $EIPPRAP[$i]  {  ipconfig /flushdns }
      icm -ComputerName $EIPPRAP[$i]  { iisreset /start}
    #Get-eventlog -log application   -after $t1   -before $t2   -ComputerName  $EIPPRAP[$i] | Export-Csv "C:\perfmon\20140517_1030_1159.csv" -Force
   #$t12=get-date
  # (($t12-$t11).TotalMinutes).ToString() + "  Minutes  "
}
schtask
Get-eventlog -log application   -after $t1   -before $t2   -ComputerName  $AP65
Get-eventlog -log application   -after $t1   -before $t2   -ComputerName   00DPHCSSC01


Get-eventlog -log application   -InstanceID 1073767893  -ComputerName   00DPHCSSC01 |fl
icm -ComputerName  $AP73  {$env:COMPUTERNAME}
...
Invoke-Sqlcmd  -ServerInstance spe "select @@servername"

Get-eventlog -LogName Application  -ComputerName 00DPHCSSD03 -Source 
$t=Get-eventlog -LogName Application  -Source MSSQLSERVER  -Newest 5

$t |select * 
$20140517_103000 = get-date  '2014/5/17 上午 10:30:00'
$20140517_103500 = get-date '2014/5/17 上午 10:35:00'
$20140517_123000 = get-date '2014/5/17 上午 10:35:00'

--$20140111_235959 = get-date '1/11/14  23:59:59'

Get-eventlog -log application -entrytype Error -after $20140517_103000 -before $20140517_103500  -- | Export-Csv "H:\temp\169.csv" -Force

#-----------------------------------
#
#-----------------------------------

Get-ClusterResource  "SP2013_SQLE_AG_SPE"     | Set-ClusterParameter  RegisterAllProvidersIP  0
Get-ClusterResource  "SP2013_SQLE1_AG_SPE1"   | Set-ClusterParameter  RegisterAllProvidersIP  0

Get-ClusterResource  | ?  state -eq 'offline' |fl
...
Get-ClusterResource |select name |fl
Get-ClusterResource  "SP2013_SQLE_AG_SPE"   

Get-ClusterResource  "SP2013_SQLE1_AG_SPE1"     | Get-ClusterParameter  RegisterAllProvidersIP  
Get-ClusterResource  "SP2013_SQLE_AG_SPE" | select * |fl

Get-ClusterResource  "SP2013_SQLE_AG_SPE"     | Get-ClusterParameter  RegisterAllProvidersIP  0
Get-ClusterResource  "SP2013_SQLE1_AG_SPE1"   | Get-ClusterParameter  RegisterAllProvidersIP  0
Get-ClusterResource  "SQL Network Name (SQL-E1-2012)"   | Get-ClusterParameter  RegisterAllProvidersIP  0
Get-ClusterResource  "SQL Network Name (SQL-E-2012)"     | Get-ClusterParameter  RegisterAllProvidersIP  0

Get-ClusterResource  "SQL Network Name (SQL-X-2012)"     | Get-ClusterParameter  LastDNSUpdateTime |fl
Get-ClusterResource  "SQL Network Name (SQL-X1-2012)"     | Get-ClusterParameter  LastDNSUpdateTime |fl
Get-ClusterResource  "SQL Network Name (SQL-E-2012)"     | Get-ClusterParameter  LastDNSUpdateTime |fl
Get-ClusterResource  "SQL Network Name (SQL-E1-2012)"     | Get-ClusterParameter  LastDNSUpdateTime |fl

#-----------------------------------
# nslookup 
#-----------------------------------
PS C:\Users\spfarmadmin> nslookup
Default Server:  00phasnc02.mvdis.gov.tw
Address:  10.0.24.183

> spe
Server:  00phasnc02.mvdis.gov.tw
Address:  10.0.24.183

Name:    spe.mvdis.gov.tw
Addresses:  10.0.23.118
          10.1.23.118

Server:  00phasnc02.mvdis.gov.tw
Address:  10.0.24.183

Name:    spe1.mvdis.gov.tw
Addresses:  10.0.23.119
          10.1.23.119
...
New-Object System.Net.Sockets.TcpClient -ArgumentList   "10.1.24.182","389"
New-Object System.Net.Sockets.TcpClient -ArgumentList   01DPHIMSA01,"1433"


function checkNodePort ($node, $port)
{#1
$tcpclient=New-Object System.Net.Sockets.TcpClient
#$node="10.1.24.182";$port="389"
#$node='01DPHIMSA01' ;$port='80'
#$async=$tcpclient.BeginConnect("10.1.24.182","389",$Null,$NUll)
...
for ($i = 22; $i -lt 140; $i++)
{ 
    checkNodePort "10.1.24.182"   $i
}

$ps='135','137','139','161','389','445','464','500'
foreach ($p in $ps)
{
    checkNodePort "10.1.24.182"   $p
}

$ps='135','137','139','161','389','445','464','500'
foreach ($p in $ps)
{
    checkNodePort "10.5.0.13"   $p
}

telnet  10.1.24.182  389
telnet  01DPHIMSA01   80

checkNodePort  "10.1.24.182"  445
checkNodePort  "10.1.21.151"  445
checkNodePort "10.5.0.13"  445
checkNodePort "10.5.0.13"  23
telnet 10.5.0.13 445


net use \\10.5.0.13\eFileMajority /user:ClusterQ "1q2w#E$R"
net use /?
